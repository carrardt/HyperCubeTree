...
template <typename _T, unsigned int _D, typename _Mask> struct CubeEnum
{
	...
	CubeEnum< T, D - 1, CBitField<Bit0, Mask> > _0; // Ensemble des elements dont le premier bit est contraint à 0
	CubeEnum< T, D - 1, CBitField<BitX, Mask> > _X; // Ensemble des elements dont le premier bit est libre
	CubeEnum< T, D - 1, CBitField<Bit1, Mask> > _1; // Ensemble des elements dont le premier bit est contraint à 1
